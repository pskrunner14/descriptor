""" InceptionV3 pre-trained model featrure extraction code taken from TorchVision.

Please see: [https://pytorch.org/docs/master/_modules/torchvision/models/inception.html#inception_v3] 
